var SelectPure = function () {
    ...
    var n = {value: "data-value", disabled: "data-disabled", class: "class", type: "type"}, c = function () {
        function i(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
            return s(this, i), this._node = e instanceof HTMLElement ? e : document.createElement(e), this._config = {i18n: n}, this._setAttributes(t), t.textContent && this._setTextContent(t.textContent), this
        }
    ...
    return function () {
        function n(e, t) {
            s(this, n), this._config = o(o({}, t), {}, {
                classNames: o(o({}, r), t.classNames),
                disabledOptions: []
            }), this._state = {opened: !1}, this._icons = [], this._boundHandleClick = this._handleClick.bind(this), this._boundUnselectOption = this._unselectOption.bind(this), this._boundSortOptions = this._sortOptions.bind(this), this._body = new c(document.body), this._create(e), this._config.value && this._setValue()
        }
        ...
        return e(n, [{
            ...
            key: "_setValue", value: function (e, t, n) {
                ...
                if (!(-1 < this._config.disabledOptions.indexOf(e))) {
                    ...
                    }) : this._config.options[0], a = this._options.find(function (e) {
            ...
            key: "_selectOptions", value: function (e, t) {
                ...
                this._label.setText(""), this._icons = e.map(function (e) {
                    var t = new c("span", {class: i._config.classNames.selectedLabel, textContent: e.label}),
            ...
            key: "_unselectOption", value: function (e) {
                var t = l(this._config.value), n = t.indexOf(e.target.getAttribute("data-value"));
                -1 !== n && t.splice(n, 1), this._setValue(t, !0, !0)
            }
        }, {
            key: "_sortOptions", value: function (t) {
                var n = this;
